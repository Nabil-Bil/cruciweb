...
<div class="container">
  <div class="header">
    <h1>Utilisateurs</h1>
    <a href="#" class="add-button">Ajouter</a>
  </div>
  <table>
    <thead>
    <tr>
    ...
    <tr>
      ...
      <td class="action-buttons">
        ...
        <form action="<%=request.getContextPath().concat(Routes.USERS_ROUTE)%>" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet utilisateur ?');">
